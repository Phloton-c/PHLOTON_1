...
void setup() {
  ...
  timer = timerBegin(0, 100, true);  // Timer 0, prescaler 80 (1 µs ticks)
  ...
  if (!SD.begin(SD_CS)) {
    ...
    if (myFile) {
      ...
      if (myFile.size() == 0) {
        ...
        myFile.print(", ");
        myFile.print("Flask average Temperature ");
        myFile.print(", ");
        myFile.print("TEC Status");
        myFile.print(", ");
        myFile.print("HS FAN Status ");
        myFile.print(", ");
        myFile.print("CS FAN Status ");
        myFile.print(", ");
        myFile.print("TEC Dutycycle ");
        myFile.print(", ");
        myFile.print("HS FAN Dutycycle ");
        myFile.print(", ");
        myFile.println("CS FAN Dutycycle ");
...
float readBatteryVoltage() {
  ...
  float BATT_VSNS_voltage = BATT_VSNS_adcValue * (3.34 / 4095.0);
        ...
        if (HS_Fan_Check()) {
          if (CS_Fan_Check()) {
            while (digitalRead(LID) == HIGH) {
              ...
              Serial.print("TEC Status: ");
              Serial.println(TEC_Status);
              Serial.print("HS FAN Ststus: ");
              Serial.println(HS_FAN_Status);
              Serial.print("CS FAN Status: ");
              ...
              if (myFile) {
                ...
                myFile.print(",");
                myFile.print(Flask_avg_temp);
                myFile.print(",");
                myFile.print(TEC_Status);
                myFile.print(",");
                myFile.print(HS_FAN_Status);
                myFile.print(",");
                myFile.print(CS_FAN_Status);
                myFile.print(",");
                myFile.print(TEC_dutyCycle);
                myFile.print(",");
                myFile.print(HS_dutyCycle);
                myFile.print(",");
                myFile.println(CS_dutyCycle);
                myFile.close();
              } else {
                Serial.println("Error opening file for appending");
              }
